...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        // Additional note : goals scored and conceded have to be added for each appearance of the team
        let team_1_struct = scores.entry(team_1_name.clone()).or_insert(Team{
        ...
        let team_2_struct = scores.entry(team_2_name.clone()).or_insert(Team{
