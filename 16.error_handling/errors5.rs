...
// updated the return type of `main()` to make this compile.
// Box is used to return anything which implements the error::Error trait (in this case ParseIntError and CreationError)
